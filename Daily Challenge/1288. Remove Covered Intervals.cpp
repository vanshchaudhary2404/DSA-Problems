...
public:
    int removeCoveredIntervals(vector<vector<int>>& intervals) {
        ...
        */
        ...
        //Approach 2 -> remove this  result.back()[0] <= intervals[i][0] because it is always true
        /*vector<vector<int>> result;
        int n = intervals.size();
        ...
        */
        ...
        //Approach 3 using variable lastIntervalEnd instead of vectro<vector<int>> result;
        int n = intervals.size();
